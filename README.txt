...
Подзадачи:
    ...
    третья - делаем матрицу, в неё записываем скорость частиц в каждой точке поля
            ...
            сделано без интерполяции, с интерполяцией по среднему арифметическому и
            со взвешенной интерполяцией
