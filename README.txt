...
Подзадачи:
    ...
    !вторая подзадача не работает, и никто не знает, почему
    ...
    Журавлёв сказал, что это - алгоритм Эйлера, есть другие, более крутые, например - Рунге-Кутты,
    его тоже можно запилить
